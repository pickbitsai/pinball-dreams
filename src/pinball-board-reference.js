(function (global) {
    ...
    const profiles = {
        Classic: {
            ...
            guides: [
                [[0.13, 0.72], [0.09, 0.64], [0.09, 0.46], [0.14, 0.34]],
        ...
        Vortex: {
            ...
            guides: [
                ...
                [[0.75, 0.73], [0.83, 0.56], [0.77, 0.38], [0.62, 0.27]]
            ],
        ...
        Castle: {
            ...
            guides: [
                [[0.12, 0.73], [0.10, 0.57], [0.18, 0.43], [0.34, 0.33]],
        ...
        Wave: {
            ...
            guides: [
                [[0.11, 0.74], [0.08, 0.62], [0.16, 0.49], [0.31, 0.40]],
                [[0.77, 0.74], [0.82, 0.59], [0.73, 0.45], [0.58, 0.35]]
            ],
